...
struct LoginInputView: View {
  ...
  private let activeBlue = Color(red: 0x06 / 255.0, green: 0xBA / 255.0, blue: 0xFF / 255.0)
    ...
    VStack(spacing: 16) {
      ...
      HStack(spacing: 4) {
        ...
        HStack(spacing: 6) {
          ...
          Rectangle()
            .fill(Color(red: 0xE5 / 255.0, green: 0xE5 / 255.0, blue: 0xE5 / 255.0)) // Neutral-200
      ...
      .overlay(
        RoundedRectangle(cornerRadius: 6)
          .stroke(Color(red: 0xF4 / 255.0, green: 0xF4 / 255.0, blue: 0xF5 / 255.0), lineWidth: 1) // Zinc-100
      )
