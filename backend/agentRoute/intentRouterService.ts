...
const SYSTEM_PROMPT = [
  ...
  '- reminder.create: 创建提醒（slots: title, when）。',
  '- contact.manage: 联系人相关操作（slots: contactName, contactAction, messageBody）。',
  '- task.create: 创建任务（slots: taskTitle, dueTime）。',
  '- food.create: 新增美食记忆（slots: name, category, pricePerPerson, review, features, signatureDishes, avoidDishes）。',
  '- chat.reply: 普通聊天回复。',
